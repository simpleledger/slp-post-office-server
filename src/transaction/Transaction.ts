...
class Transaction implements ITransaction {
    ...
    getNeededStamps(transaction: any): number {
        ...
        const transactionScript = bchjs.Script.toASM(transaction.outs[Transaction.SLP_OP_RETURN_VOUT].script).split(' ')
    ...
    splitUtxosIntoStamps(utxos: any, hdNode: any) {
            const transactionBuilder = config.network === 'mainnet' ? new bchjs.TransactionBuilder() : new bchjs.TransactionBuilder('testnet')
